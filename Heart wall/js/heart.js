$(function () {
    ...
    var data = [
        {id:1,xysj: "2018-7-19 22:27:2", xy: "希望明天捡十块钱！", name:"见钱眼开", jssj:1533105211082},
        {id:2,xysj: "2018-7-19 22:29:5", xy: "希望明天死情敌！", name:"死了都要爱", jssj:1533511211082},
    ...
    $('.privary>input').click(function (e) {
        ...
        if ($(this).attr('tada-n') === 'y' && $(this).attr('class') === 'check clor') {
            ...
            $('.mask').show().css({
                    'zIndex': mIndex,
                    height: $('#content')[0].offsetHeight+100,
                })
    ...
    function cjfun(arr){
        ...
        $.each(arr, function (i, ele) {
            ...
            ele.timer = setInterval(function () {
                $('.tip1').eq(arr[i].id-1).find('.dtime').html(fndjs(ends));
            }, 1000);
